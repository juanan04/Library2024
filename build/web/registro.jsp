...
<html>
    <head>
        ...
        <title><fmt:message key="title.signup.library"/></title>
    ...
    <body>
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <h2 class="mb-4"><fmt:message key="msg.register"/></h2>
                    <form action="Registro" method="post">
                        <div class="mb-3">
                            <label for="nombre" class="form-label"><fmt:message key="form.label.name"/></label>
                            <input type="text" class="form-control" id="nombre" name="nombre" required>
                        </div>
                        <div class="mb-3">
                            <label for="apellidos" class="form-label"><fmt:message key="form.label.surname"/></label>
                        ...
                        <div class="mb-3">
                            <label for="domicilio" class="form-label"><fmt:message key="form.label.address"/></label>
                            <input type="text" class="form-control" id="domicilio" name="domicilio" required>
                        </div>
                        <button type="submit" class="btn btn-primary"><fmt:message key="nav.menu.register"/></button>
                    </form>
                </div>
            </div>
        </div>
